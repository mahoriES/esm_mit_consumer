...
class BusinessDetailsPopup extends StatefulWidget {
  ...
  const BusinessDetailsPopup({@required this.businessTitle,
...
class _BusinessDetailsPopupState extends State<BusinessDetailsPopup>
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: AppSizes.separatorPadding),
        child: ClipRRect(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildMerchantAddressRow(
                          context, widget.businessPrettyAddress,
...
class eSamudaayAnimatedLogo extends AnimatedWidget with AppLogoVariationProviderMixin {
...
mixin MerchantWidgetElementsProviderMixin {
  ...
  Widget contactMerchantActionButton(Function onTap) {
    return GestureDetector(onTap: onTap, child: const Icon(
  ...
  Widget shareActionButton(Function onShare) {
    return GestureDetector(onTap: onShare, child: const Icon(
      Icons.share,
      color: AppColors.blueBerry,
    ),);
  }
